<!-- INJECTED BY ANBU PROFILER AGENT ------------------------------------------------------->
<style>
    .animated-anbu-logo {
    ...
    .animated-anbu-logo {
        -webkit-animation-name: anbuBounceIn !important;
        animation-name: anbuBounceIn !important;
    }
</style>

<a target="_blank" class="animated-anbu-logo" href="{{ $url }}">
    ...
    <span>View this request on anbu.io</span>
</a>
<!-- INJECTED BY ANBU PROFILER AGENT ------------------------------------------------------->
